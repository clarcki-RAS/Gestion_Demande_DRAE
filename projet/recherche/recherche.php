			...
			<nav class="navbar navbar-header navbar-expand-lg" data-background-color="green2">
				...
				<div class="container-fluid">
					<div class="collapse" id="rechercher-nav">
						<form class="navbar-left navbar-form nav-rechercher mr-md-3" action="../recherche/recherche.php" method="POST">
							<div class="input-group">
								<div class="input-group-prepend">
								
									<button type="" class="btn btn-rechercher pr-1">
										<i class="fa fa-rechercher rechercher-icon"></i>
									</button>
									
								</div>
								<input type="text" placeholder="Rechercher d'un colis..." class="form-control" name="idenvoi" id="idenvoi">
							</div>
									...
									<div class="row">
										<table id="add-row" class="display table table-striped table-hover" >
											<thead>
												<tr>
													<th>Id d'envoi</th>
													<th>Code du voiture</th>
													<th>Colis</th>
													<th>Nom de l'envoyeur</th>
													<th>Email de l'evoyeur</th>
													<th style="width: 5cm">Date d'envoi</th>
													<th>Frais</th>
...
$reponse = $bdd->query("SELECT * FROM ENVOYER where idenvoi like '$idenvoi'");
