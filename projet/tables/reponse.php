										...
										<table id="add-row" class="display table table-striped table-hover" >
											<thead>
												<tr>
													...
													<th>Etat des demandes</th>
													<th>date de formation</th>
													<th>date de reception materiel</th>
													<th>filiere d'activite</th>
													<th>type d'appuis demamder</th>
													<th>materiel valide</th>
													
							
													<th style="width: 10%">Imprimer en PDF</th>
												</tr>
											</thead>
											<tbody 
											<?php
...
$reponse = $bdd->query('SELECT * FROM demander  JOIN repondre on demander.ID_PAYSANT=repondre.ID_PAYSANT JOIN paysant on
...
?>
											>
												<tr>
													...
													<td><?php echo $donnees['DATE_FORMATION']; ?> </td>
													<td><?php echo $donnees['DATE_RECEP_MATERIEL']; ?> </td>
													...
													<div class="form-button-action">
															...
															<a class="btn btn-link btn-primary btn-lg"   href="../FPDF/ticket.php?idpaysant=<?php echo $donnees['ID_PAYSANT']?>"><i class="fa fa-print"></i></a>
