...
$reponse = $bdd->query('SELECT * FROM demander INNER JOIN paysant on demander.ID_PAYSANT=paysant.ID_PAYSANT ');
											...
											>
												<tr>
													...
													<div class="form-button-action">
															...
															<a class="btn btn-link btn-primary btn-lg"   href="../FPDF/imprimer.php?idpaysant=<?php echo $donnees['ID_PAYSANT']?>"><i class="fa fa-print"></i></a>
