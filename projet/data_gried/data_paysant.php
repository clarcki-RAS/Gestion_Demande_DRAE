...
$reponse = $bdd->query('SELECT * FROM paysant ');
...
?>
		...
		<tr><td><?php echo $donnees['ID_PAYSANT']; ?> </td>
			<td><?php echo $donnees['NOM_EAF']; ?></td>
			<td><?php echo $donnees['DATE_NAISS']; ?> </td>
			<td><?php echo $donnees['SEXE']; ?> </td>
            <td><?php echo $donnees['CIN_PAYSANT']; ?> </td>
            <td><?php echo $donnees['REGION']; ?> </td>
            <td><?php echo $donnees['COMMUNE']; ?> </td>
            <td><?php echo $donnees['DISTRICT']; ?> </td>
            <td><?php echo $donnees['VILLAGE']; ?> </td>
            <td><?php echo $donnees['FOKONTANY']; ?> </td>
            <td><?php echo $donnees['NUM_TEL_PAY']; ?> </td>
            
			<td>
			
                <div class="form-button-action">
                            <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Modifier">
                                <a class="btn btn-link btn-primary btn-lg"   href="modif_paysant.php?id=<?php echo $donnees['ID_PAYSANT'] ?>"> <i class="fa fa-edit"></i></a>
                            </button>
                </div>
			</td>
			<td>
			<div class="form-button-action">
				<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Supprimer">
                            <a class="btn btn-link btn-danger" href="suppression_pay.php?id=<?php echo $donnees['ID_PAYSANT'] ?>"><i class="fa fa-times"></i></a>	
                </button>
			</div>	
			</td>
		</tr>
	...
	?>
		...
		<nav class="navbar navbar-dark bg-info justify-content-between" style="margin-right: -18%;" ></nav>
