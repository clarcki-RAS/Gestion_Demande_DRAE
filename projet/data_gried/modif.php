...
$nom_assoc = $_GET['id'];
$query = "SELECT *FROM ASSOCIATION WHERE NOM_ASSOC='$nom_assoc'";
...
if (isset($_POST['modification']))
{
    ...
    if(isset($NOM_ASSOC) && isset($NBR_MEMBRES) && isset($DATE_DE_FONDATION) && isset($CONTACT)
    && !empty($NOM_ASSOC) && !empty($NBR_MEMBRES) && !empty($DATE_DE_FONDATION) && !empty($CONTACT) )
    {
								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-6 col-lg-4">
											<h1>ASSOCIATION DES PAYSANTS</h1>
											...
											<?php foreach($res as $row):?>
												...
												<div class="form-group">
													...
													<input type="number" class="form-control" id="contact" placeholder="03XXXXXXXXX" name="contact" value="<?=$row['CONTACT']?>">
												</div>
