...
$reponse = $bdd->query('SELECT * FROM production ');
		...
		<tr>
			...
			<td>
                ...
                <div class="form-button-action">
                            <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Modifier">
                                <a class="btn btn-link btn-primary btn-lg"   href="modif_prod.php?id=<?php echo $donnees['IDENTIFIANT'] ?>"> <i class="fa fa-edit"></i></a>
                            </button>
                </div>
			</td>
			<td>
			<div class="form-button-action">
				<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Supprimer">
                            <a class="btn btn-link btn-danger" href="suppression_prod.php?id=<?php echo $donnees['IDENTIFIANT'] ?>"><i class="fa fa-times"></i></a>	
                </button>
			</div>	
			</td>
		</tr>
