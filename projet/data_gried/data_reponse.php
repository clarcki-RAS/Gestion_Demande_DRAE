...
$reponse = $bdd->query('SELECT * FROM repondre ');
...
?>
		...
		<tr><td><?php echo $donnees['ID_PAYSANT']; ?> </td>
            ...
            <td><?php echo $donnees['MATERIEL_VALIDE']; ?> </td>
			...
			<td>
                <div class="form-button-action">
                            <button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Modifier">
                                <a class="btn btn-link btn-primary btn-lg"   href="modif_rep.php?id=<?php echo $donnees['ID_PAYSANT'] ?>"> <i class="fa fa-edit"></i></a>
                            </button>
                </div>
			</td>
			<td>
			<div class="form-button-action">
				<button type="button" data-toggle="tooltip" title="" class="btn btn-link btn-danger" data-original-title="Supprimer">
                            <a class="btn btn-link btn-danger" href="suppression_rep.php?id=<?php echo $donnees['ID_PAYSANT'] ?>"><i class="fa fa-times"></i></a>	
                </button>
			</div>	
			</td>
		</tr>
