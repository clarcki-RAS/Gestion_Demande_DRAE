...
$id_resp = $_GET['id'];
$query = "SELECT *FROM responsable WHERE ID_RESPONSABLE='$id_resp'";
...
if (isset($_POST['modification']))
{
    ...
    && !empty($id)&& !empty($nom)  )
    {
        $query = "UPDATE responsable SET ID_RESPONSABLE=?,NOM_RESP=?,NUM_TEL=?,CIN=? WHERE ID_RESPONSABLE=$id";
        $pdostmt=$bdd->prepare($query);
        $reponse = $pdostmt->execute(array($id,$nom,$num,$cin));
        if($reponse)
        {
								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-6 col-lg-4">
											...
											<form  method="POST" action="modif_resp.php">
											<?php foreach($res as $row):?>
												<div class="form-group">
													<label for="id">Identifiant du responsable :</label>
													<input type="text" class="form-control" id="id" placeholder="ID" name="id" value="<?=$row['ID_RESPONSABLE']?>" readonly="readonly">
												</div>
												<div class="form-group">
													<label for="nom">Nom et prenom </label>
													<input type="text" class="form-control" id="nom" placeholder="nom du responsable" name="nom"value="<?=$row['NOM_RESP']?>">
												</div>
												<div class="form-group">
													<label for="cin">Numero du cin</label>
													<input type="number" class="form-control" id="cin" placeholder="cin du responsable" name="cin"value="<?=$row['CIN']?>">
												</div>
												<div class="form-group">
													<label for="num">contact </label>
													<input type="tel" class="form-control" id="num" placeholder="03XXXXXXXXX" name="num"value="<?=$row['NUM_TEL']?>">
												</div>
