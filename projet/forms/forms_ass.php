									...
									<div class="container">
											...
											<form name="insertion1" action="ajout_ass.php" method="POST">
												<div class="form-group">
													...
													<input type="text" class="form-control" id="nom_assoc" placeholder="Entrer le nom de l'association" name="nom_assoc" required>
												</div>
												<div class="form-group">
													<label for="nbr_membres">Nombres des adherents </label>
													<input type="number" class="form-control" id="nbr_membres" placeholder="nombres des membres" name="nbr_membres">
												</div>
												<div class="form-group">
													<label for="date_de_fondation">Date de fondation</label>
													<input type="date" class="form-control" id="date_de_fondation" placeholder="la date de creation" name="date_de_fondation">
												</div>
												<div class="form-group">
													<label for="contact">contact </label>
													<input type="number" class="form-control" id="contact" placeholder="03XXXXXXXXX" name="contact" required>
												</div>
