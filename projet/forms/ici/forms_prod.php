								...
								<div class="card-body">
									<div class="row">
										<div class="col-md-6 col-lg-4">
											<h1>ENREGISTREMENT DES PRODUCTIONS AGRICOLES</h1>
											<form name="insertion1" action="ajout_production.php" method="POST">
												...
												<div class="form-group">
													...
													<input type="number" class="form-control" id="id_produit" placeholder="id du produit a enregistrer" name="id_produit">
												</div>
												<div class="form-group">
													<label for="quantite">Quantite de production</label>
													<input type="number" class="form-control" id="quantite" placeholder="quantite en kg" name="quantite">
												</div>
												<div class="form-group">
													<label for="date_prod">Date de production </label>
													<input type="datetime-local" class="form-control" id="date_prod" placeholder="date de production " name="date_prod">
												</div>
                                                <div class="form-group">
													<label for="nom_produit">Libelle </label>
													<input type="text" class="form-control" id="nom_produit" placeholder="nom du produit  " name="nom_produit">
												</div>


												<div class="card-action">
													<input class="btn btn-danger" type="submit" value="Ajouter" name="btn-valider" >
												</div>
											</form>
