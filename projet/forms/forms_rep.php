				...
				<div class="page-inner">
					...
					<div class="container">
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title"> R E P O N S E S A B L E <span class="mx-3"> D E S </span> D E M A N D E S </div>
								</div>
								<div class="card-body">
								
						<form name="insertion1" action="ajout_reponse.php" method="POST">
						...
						<div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" id="date_formation" placeholder="identifiant du paysant" name="date_formation">
                            </div>
                        </div>
                        </div>
						...
						<div class="col-12 col-md-6 col-lg-6">
							<div class="form-group">
                                ...
                                <input type="date" class="form-control" id="date_recep_materiel" placeholder="branche d'activite" name="date_recep_materiel">
                            </div>
                        </div>
                        </div>
						...
						<div class="col-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="materiel_valide" name="materiel_valide">
                            </div>
						</div>
						<div class="col-12 col-md-6 col-lg-6">
                            <div class="form-group">
                                <label for="etat"  name ="etat">Reponse de la direction :</label>
                                    <select name="etat" class="form-control">
                                        ...
                                        <option value="reffus">REFUSER</option>
                                    </select>
                            </div>
						</div>
						</div>
