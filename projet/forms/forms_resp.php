						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">R E S P O N S A B L E S <span class="mx-3"> D E S </span> DEMANDES</div>
								</div>
								<div class="card-body">
									
											
						<form name="insertion1" action="ajout_responsable.php" method="POST">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="nom" placeholder="nom du responsable" name="nom">
												</div>
												<div class="form-group">
													<label for="cin">Numero du cin</label>
													<input type="number" class="form-control" id="cin" placeholder="cin du responsable" name="cin">
												</div>
												<div class="form-group">
													<label for="num">contact </label>
													<input type="tel" class="form-control" id="contact" placeholder="03XXXXXXXXX" name="num">
												</div>
